...
1. Make an [Issue](https://github.com/ligofff/lgf-weighted-random/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-weighted-random": "https://github.com/YOUR_USER/lgf-weighted-random.git"
        }
    }
```
